...
const books: BookResource[] = [
  {
    ...
    keyInsight:
      "Wealth is what you don't see. The ability to do what you want, when you want, for as long as you want, is the highest dividend money pays.",
  ...
  },
  {
    ...
    keyInsight:
      'Most millionaires are ordinary people who live below their means, save consistently, and invest wisely. Wealth is built through discipline, not income.',
  ...
  },
  {
    ...
    author: 'JL Collins',
    keyInsight:
      'Invest in low-cost index funds, avoid debt, and live below your means. Financial independence is achievable through simplicity and consistency.',
  ...
  },
  {
    ...
    author: 'Ramit Sethi',
    keyInsight:
      "Spend extravagantly on the things you love, and cut costs mercilessly on the things you don't. Automate your finances to build wealth effortlessly.",
  ...
  },
  {
    ...
    keyInsight:
      'Money is life energy. Calculate your real hourly wage after expenses, and make every purchase decision based on whether it brings you fulfillment.',
  ...
  },
  {
    ...
    keyInsight:
      'Keep investing simple: low-cost index funds, broad diversification, and a long-term perspective. Costs matter more than you think.',
  ...
  },
  {
    ...
    keyInsight:
      "The stock market is efficient in the long run. You can't consistently beat the market, so invest in low-cost index funds and hold for the long term.",
    ...
    <div className="space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-xl text-text-secondary max-w-3xl mx-auto">
          Essential books to deepen your understanding of personal finance, investing, and building
          wealth
        </p>
      </div>
      ...
      <FintechCard variant="info">
        <div className="space-y-4">
          <h3 className="text-lg font-semibold text-text-primary">
            The Methodology Behind This Tool
          </h3>
          ...
          <ul className="space-y-2 text-sm text-text-secondary">
            <li>
              ...
              <span className="text-text-primary font-medium">
                The Trinity Study (Bengen 1994, Cooley et al. 1998)
              </span>{' '}
              — basis for the 4% safe withdrawal rate
            </li>
            <li>
              •{' '}
              <span className="text-text-primary font-medium">
              ...
              — the Fixed / Investments / Guilt-Free bucket structure
            </li>
            <li>
              •{' '}
              <span className="text-text-primary font-medium">
              ...
              — index fund philosophy and FI/RE principles
            </li>
          </ul>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {books.map((book) => (
          <FintechCard
            ...
            className="hover:shadow-xl transition-shadow h-full flex flex-col"
          >
            <div className="flex flex-col flex-grow">
              ...
              <div className="mb-4">
                ...
                <p className="text-sm text-text-secondary font-medium">by {book.author}</p>
              </div>
