...
| Step 4 — Investment Path | partial (single-engine v1) | tokens, a11y; cone honest pending real MC |
| Step 5 — Summary | **yes (cold audit v1)** | row 9 offset caveat, disclaimer contrast, dead tokens, zero-target bug |
| Bonus — CompoundCalculator / Resources | no | dedupe orphans, a11y |
